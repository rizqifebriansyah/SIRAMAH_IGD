...
class RadiologiController extends Controller
{
    ...
    public function updateradiologi(Request $request)
    {
        ...
        $update = DB::connection('mysql3')->select('UPDATE order_table a SET MODALITY = ? WHERE ACCESSIONNUMBER = ?', [$modality, $acc]);
    ...
    public function carigambarbridgingg(Request $request)
    {
        // $unit = auth()->user()->unit;
...
|||" . $alamat,
    ...
    public function returorderrad(Request $request)
    {
        ...
        // dd($kodekunjungan);
        $cek = DB::select('SELECT status_kunjungan, tgl_keluar FROM ts_kunjungan WHERE kode_kunjungan = ?', [$kodekunjungan]);
        ...
        } elseif ($cek[0]->status_kunjungan == 2 && $cek[0]->tgl_keluar == null) {
            try {
    ...
    public function cetakexpertisee(Request $request)
    {
    ...
    public function cetakexpertise2($acc)
    {
