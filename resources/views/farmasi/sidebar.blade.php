...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">SIRAMAH IGD FARMASI</span>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-header">REKONSILIASI OBAT</li>
                <li class="nav-item">
                    <a href="{{ route('farmasi') }}" class="nav-link @if($menu == 'farmasi' ) active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('kpoo') }}" class="nav-link @if($menu == 'kpo' ) active @endif">
                        <i class="nav-icon fas fa-archive"></i>
                        <p>
                            KPO Elektronik
                        </p>
