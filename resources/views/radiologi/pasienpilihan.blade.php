<div class=" col-md-11" style="margin-bottom:10px ;">
    ...
    <a style="margin-left: 32px;" rel="noopener" href="{{ route('radiologi')}}" class="btn btn-danger"><i class="fas fa-arrow-left"></i> Home
    </a>
</div>
        ...
        <div class="card-body">
            <div class="col-md-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="komplikasikb" id="komplikasikb" value="PID / radang panggul">
...
<script>
    ...
    $(".riwayatradiologi").click(function() {
        ...
        $.ajax({
            ...
            url: " {{ route('riwayatpasienradiologi') }}",
            error: function(data) {
                spinner.hide();
                alert('error!!')
            },
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.kode == 500) {
                            ...
                            etiketrad(data.idhed, data.kode_header)
                            window.location.reload();
    ...
    function pdf(idhed, kode_header) {
        ...
        window.open('cetakorderradiologi/' + kode_header + '/' + idhed);
    }

    function etiketrad(idhed, kode_header) {

        window.open('etiketrad/' + kode_header + '/' + idhed);
    }
</script>