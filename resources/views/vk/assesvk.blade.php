...
<div class="card-body ermperawatview">
    <div class="row" style="align-content: 10px;">
        <h4 class="col-md-12">Cari Pasien VK</h4>
        ...
        <div>
            <button type="submit" class="btn btn-primary" onclick="caripasienvk()"> <i class="bi bi-search-heart"></i>
            </button>
        </div>
        <div class="col-md-12 datapasienvk">

        </div>
    </div>
    <div class="row mt-2" style="align-content: 10px;">

        <h4 class="col-md-5">Data Pasien VK</h4>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="status1" style="text-align: center;">
                            ...
                            @else
                            <button class="badge badge-warning "> belum validasi </button> | {{ $a->nama_perawat }}
