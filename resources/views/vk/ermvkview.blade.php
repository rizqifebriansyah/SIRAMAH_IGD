            ...
            <div class="col-md-2">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        @endif
                        <a href="#" class="btn btn-primary btn-block riwayatcpptlain"><b>Catatan
                                Medis</b></a>
                    </div>
...
<script>
    ...
    $(".riwayatcpptlain").click(function() {
        spinner = $('#loader2');
        spinner.show();
        norm = $('#norm').val()
