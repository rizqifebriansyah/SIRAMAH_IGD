                       ...
                       <div class="row">
                           ...
                           <div class="col-md-3">
                               ...
                               <select class="form-control  select2" name="waktumakan" id="waktumakan" placeholder="Cari opsi...">
                                   @if ($time >= '07:00:00' && $time <= '10:00:00' ) <option value="MAKAN SIANG">MAKAN SIANG</option>
                                       @elseif ($time >= '13:00:00' && $time <= '14:30:00' ) <option value="MAKAN MALAM">MAKAN MALAM</option>
                                           @else
                           ...
                           <div class="col-md-3">
                               <label for="">BENTUK MAKAN</label>
                               <select class="form-control  select2" name="bentuk" id="bentuk" placeholder="Cari opsi...">
                                   <option>--- PILIH BENTUK MAKAN ---</option>
                               ...
                               <input type="text" name="bentuk1" id="bentuk1" class="form-control">
   ...
   <script>
       ...
       $(document).ready(function() {
           ...
           fieldHTML = fieldHTML + '<div class="col-md-3"><label for="">Waktu Makan</label><select class="form-control  select2" name="waktumakan" id="waktumakan" placeholder="Cari opsi..."> @if ($time >= "07:00:00" && $time <= "10:00:59" ) <option value="MAKAN SIANG">MAKAN SIANG</option>@elseif ($time >= "13:00:00" && $time <= "16:00:00" ) <option value="MAKAN MALAM">MAKAN MALAM</option>@else<option value="MAKAN PAGI">MAKAN PAGI</option>@endif</select></div>';
           fieldHTML = fieldHTML + ' <div class="col-md-3"><label for="">BENTUK MAKAN</label> <select class="form-control  select2" name="bentuk" id="bentuk" placeholder="Cari opsi..."><option>--- PILIH BENTUK MAKAN ---</option> <option value="Makanan Biasa">Makanan Biasa</option> <option value="Makanan Tim">Makanan Tim</option> <option value="Makanan Lunak">Makanan Lunak</option> <option value="Makanan Saring">Makanan Saring</option> <option value="Makanan Cair">Makanan Cair</option> <option value="Bubur Kecap">Bubur Kecap</option> <option value="Blenderize">Blenderize</option></select><label for="">LAIN</label><input type="text" hidden name="unit" id="unit" value="{{$unit}}" class="form-control"><input type="text" name="bentuk1" id="bentuk1" class="form-control"></div>';
       ...
       $(".simpanordergizi").click(function() {
           ...
           alert(JSON.stringify(formordergizi));
           Swal.fire({
