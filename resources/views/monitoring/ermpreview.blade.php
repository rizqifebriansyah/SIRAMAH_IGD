                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-bold font-italic">Tanggal Kunjungan </td>
                                    <td>
                                        <input class="form-control" type="datetime-local" value="{{$assesdok[0]->tgl_kunjungan}}" name="tgl_kunjungan" id="tgl_kunjungan">
...
<div id="printableArea">
    ...
    <div class="card-body">
        ...
        <script>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            url: '<?= route('cetakresumedokterkebidanan') ?>',
                            error: function(data) {
                                spinner.hide()
                                Swal.fire({
                                    icon: 'error',
                            ...
                            success: function(data) {
                                ...
                                cetaktresumekebidanan(data.kj, data.norm)
            ...
            function cetaktresumekebidanan(kj, norm) {
                window.open('cetaktresumekebidanan/' + kj + '/' + norm);
