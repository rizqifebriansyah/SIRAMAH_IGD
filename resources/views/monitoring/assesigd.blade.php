                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="status1" style="text-align: center;">
                            ...
                            @else
                            <button class="badge badge-success ermpreview"> Sudah Diisi </button> | {{ $a->nama_perawat }} {{ $a->nama_perawat1 }}
                            @endif
                        ...
                        <td class="status2" style="text-align: center;">
                           @if ($a->nama_paramedis == null)
                            <button class="badge badge-danger ermpreview"> belum diisi </button>
                            @else
                            <button class="badge badge-success ermpreview"> Sudah Diisi </button> | {{ $a->nama_paramedis }}
                            @endif
                        </td>
