<div class=" col-md-11" style="margin-bottom:10px ;">
    ...
    <a style="margin-left: 32px;" rel="noopener" href="{{ route('bankdarah')}}" class="btn btn-danger"><i class="fas fa-arrow-left"></i> Home
    </a>
</div>
...
<div class=" col-md-11" style="margin-left:32px ;">
    <div class="card">
        ...
        <div class="card-header bg-secondary">Data Pasien Bank Darah</div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-2">
                        ...
                        <button class="btn btn-success riwayatbankdarah" id="riwayatbankdarah"><i class="fas fa-eye">
        ...
        <div class="card-body">
            <form action="" method="post" class="formtindakan">
                ...
                <div class="input_fields_wrap">
                    ...
                    <button type="button" class="btn btn-warning mb-2 simpanorderbnd" id="simpanorderbnd">Simpan Tindakan</button>
...
<script>
    ...
    $(".riwayatbankdarah").click(function() {
        spinner = $('#loader2');
        spinner.show();
        norm = $('#norm').val()
        ...
        $.ajax({
            ...
            url: " {{ route('riwayatpasienbankdarah') }}",
            error: function(data) {
                spinner.hide();
                alert('error!!')
            },
    ...
    $(".simpanorderbnd").click(function() {
        var data = $('.formtindakan').serializeArray();
        var kodekunjungan = $('#kodekunjungan').val()
        var goldar = $('#golongan_darah').val()
        var qtydarah = $('#qty_darah').val()
