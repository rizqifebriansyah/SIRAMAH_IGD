...
<body class="dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
    <div class="preloader2" id="loader2">
        <div class="loading">
            <img src="{{ asset('public/img/waled.gif') }}" width="80">
            <p>Harap Tunggu</p>
        </div>
    </div>
    <div class="wrapper">
        @include('reporting.navbar')
        @include('reporting.sidebar')
        <div class="content-wrapper">
            @yield('container')
        </div>
        <footer class="main-footer">
            <strong><a href="https://adminlte.io">SIRAMAH REPORTING</a>.</strong>
