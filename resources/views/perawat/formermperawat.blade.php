        ...
        <form action="" class="formerm">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko bersihan jalan nafas tidak efektif">
                                                    <label class="form-check-label">Aktual / Risiko bersihan jalan
                                                        nafas tidak efektif</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko pola nafas tidak efektif">
                                                    <label class="form-check-label">Aktual / Risiko pola nafas
                                                        tidak efektif</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan pertukaran gas">
                                                    <label class="form-check-label">Aktual / Risiko gangguan
                                                        pertukaran gas</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan sirkulasi">
                                                    <label class="form-check-label">Aktual / Risiko gangguan
                                                        sirkulasi</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan
                                                            perfusi jaringan / cerebral ">
                                                    <label class="form-check-label">Aktual / Risiko gangguan
                                                        perfusi jaringan / cerebral </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Hipertermia">
                                                    <label class="form-check-label">Hipertermia </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan keseimbangan cairan">
                                                    <label class="form-check-label">Aktual / Risiko gangguan
                                                        keseimbangan cairan </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan integritas kulit">
                                                    <label class="form-check-label">Aktual / Risiko gangguan
                                                        integritas kulit </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko cemas / takut">
                                                    <label class="form-check-label">Aktual / Risiko cemas / takut
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Risiko penyebaran toksik">
                                                    <label class="form-check-label">Risiko penyebaran toksik
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="risiko jatuh / cedera">
                                                    <label class="form-check-label">risiko jatuh / cedera</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="nyeri">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Umur pasien ..." aria-label="Suhu tubuh pasien" name="usia" id="usia" aria-describedby="basic-addon2" value="{{ $assesper[0]->umur }}">
                                                <div class="input-group-append">
                                                    <span class="input-group-text" id="basic-addon2"> th</span>
                                                </div>
                                            </div>
            ...
            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                @if ( $assesper[0]->diagnosa_perawat == 'Aktual / Risiko bersihan jalan nafas tidak efektif')
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko bersihan jalan nafas tidak efektif" checked>
                                                ...
                                                @if ( $assesper[0]->diagnosa_perawat == 'Aktual / Risiko pola nafas tidak efektif')
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko pola nafas tidak efektif" checked>
                                                ...
                                                @if ($assesper[0]->diagnosa_perawat =='Aktual / Risiko gangguan pertukaran gas')
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan pertukaran gas" checked>
                                                ...
                                                @if ( $assesper[0]->diagnosa_perawat == 'Aktual / Risiko gangguan sirkulasi')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan sirkulasi" checked>
                                                ...
                                                @if ( $assesper[0]->diagnosa_perawat == 'Aktual / Risiko gangguan perfusi jaringan / cerebral')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan perfusi jaringan / cerebral" checked>
                                                    <label class="form-check-label">Aktual / Risiko gangguan perfusi jaringan / cerebral </label>
                                                </div>
                                                @else
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan perfusi jaringan / cerebral">
                                                    <label class="form-check-label">Aktual / Risiko gangguan perfusi jaringan / cerebral </label>
                                                </div>
                                                @endif

                                                @if ($assesper[0]->diagnosa_perawat == 'Hipertermia')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Hipertermia" checked>
                                                    <label class="form-check-label">Hipertermia </label>
                                                </div>
                                                @else
                                                <div class="form-check">
                                                ...
                                                @if ( $assesper[0]->diagnosa_perawat == 'Aktual / Risiko gangguan keseimbangan cairan')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan keseimbangan cairan" checked>
                                                ...
                                                @if ($assesper[0]->diagnosa_perawat == 'Aktual / Risiko gangguan integritas kulit')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko gangguan integritas kulit" checked>
                                                ...
                                                @if ( $assesper[0]->diagnosa_perawat == 'Aktual / Risiko cemas / takut')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Aktual / Risiko cemas / takut" checked>
                                                ...
                                                @if ($assesper[0]->diagnosa_perawat == 'Risiko penyebaran toksik')
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="Risiko penyebaran toksik" checked>
                                                ...
                                                @if ($assesper[0]->diagnosa_perawat == 'risiko jatuh / cedera')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="risiko jatuh / cedera" checked>
                                                    <label class="form-check-label">risiko jatuh / cedera</label>
                                                </div>
                                                @else
                                                <div class="form-check">
                                                ...
                                                @if ($assesper[0]->diagnosa_perawat == 'nyeri')

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="diagnosakeperawatan" id="diagnosakeperawatan" value="nyeri" checked>
                                                    <label class="form-check-label">nyeri</label>
                                                </div>
                                                @else
                                                <div class="form-check">
                                                ...
                                                <textarea class="form-control" id="diagnosakeperawatan1" name="diagnosakeperawatan1" rows="2" placeholder="">{{$assesper[0]->diagnosa_perawat}}</textarea>
                ...
                <div class="accordion" id="accordionExample3">
                    ...
                    <div type="button" class="btn float-right btn-success updateassesperawat" style="margin-top: 20px;">
                        SIMPAN
                    </div>
