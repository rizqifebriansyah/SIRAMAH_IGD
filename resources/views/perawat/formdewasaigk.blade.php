                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="GCS" name="gcs" id="gcs" aria-label="Recipient's username" aria-describedby="basic-addon2" value="">
                                                    <div class="input-group-append">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="umurmenarche" id="umurmenarche" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="lamanyahaid" id="lamanyahaid" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="pembalut" id="pembalut" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2 ">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="date" name="haidterakhir" id="haidterakhir" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="TP" id="TP" value="">
                                            </div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="text" name="menikah" id="menikah" placeholder="kali" value="">
                                            </div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="text" name="menikah1" id="menikah1" placeholder="Tahun" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-group" type="text" name="G" id="G" placeholder="G:" value="">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-group" type="text" name="P" id="P" placeholder="P:" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-group" type="text" name="A" id="A" placeholder="A:" value="">
                                            </div>
                                        </div>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <textarea class="form-control" id="diagnosakebidanan" name="diagnosakebidanan" placeholder=""></textarea>
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
<div type="button" class="btn float-right btn-success simpanassesbidan" style="margin-top: 20px;">
    SIMPAN
</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="umurmenarche" id="umurmenarche" value="{{$assesper[0]->umurmenarche}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="lamanyahaid" id="lamanyahaid" value="{{$assesper[0]->lamanyahaid}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="pembalut" id="pembalut" value="{{$assesper[0]->pembalut}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2 ">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="date" name="haidterakhir" id="haidterakhir" value="{{$assesper[0]->haidterakhir}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="Text" name="TP" id="TP" value="{{$assesper[0]->TP}}">
                                            </div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="text" name="menikah" id="menikah" placeholder="kali" value="{{$assesper[0]->menikah}}">
                                            </div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check">
                                                <input class="form-check-input" size="5" type="text" name="menikah1" id="menikah1" placeholder="Tahun" value="{{$assesper[0]->menikah1}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-check">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-group" type="text" name="G" id="G" placeholder="G:" value="{{$assesper[0]->G}}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="form-group-label">P : </label>
                                                <input class="form-group" type="text" name="P" id="P" placeholder="P:" value="{{$assesper[0]->P}}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-group" type="text" name="A" id="A" placeholder="A:" value="{{$assesper[0]->A}}">
                                            </div>
                                        </div>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <textarea class="form-control" id="diagnosakebidanan" name="diagnosakebidanan" placeholder="">{{$assesper[0]->diagnosakebidanan}}</textarea>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <textarea class="form-control" id="rencanaasuhan" name="rencanaasuhan" placeholder="">{{$assesper[0]->diagnosakebidanan}}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
...
<div type="button" class="btn float-right btn-success updateassesbidan" style="margin-top: 20px;">
    Update
</div>
<div type="button" class="btn float-right btn-info mr-2 validasiassesbidan" style="margin-top: 20px;">
    Validasi
</div>
@endif
...
<script>
    ...
    $(".simpanassesbidan").click(function() {
        var norm = $('#norm').val()
        var kj = $('#kj').val()
    ...
    $(".updateassesbidan").click(function() {
        var norm = $('#norm').val()
        var kj = $('#kj').val()
        var tglmasuk = $('#tglmasuk').val()
        var sumberdata = $('#sumberdata:checked').val()
    ...
    $(".validasiassesbidan").click(function() {
