...
<head>
    ...
    <style>
        ...
        /* The Modal partograp (background) */
        .modalpartograp {
            display: none;
            /* Hidden by default */
            position: fixed;
        ...
        .closepartograp:hover,
        .closepartograp:focus {
            color: #000;
            text-decoration: none;
            cursor: pointer;
        }
...
/* The Modal laminaria (background) */
        .modallaminaria {
            display: none;
            /* Hidden by default */
            position: fixed;
        ...
        .closelaminaria:hover,
        .closelaminaria:focus {
            color: #000;
            text-decoration: none;
            cursor: pointer;
        }
        ...
        .closeskl:focus {
            ...
            cursor: pointer;
              ...
              /* The Modal transfusi (background) */
        .modaltransfusi {
            display: none;
            /* Hidden by default */
            position: fixed;
        ...
        .closetransfusi:hover,
        .closetransfusi:focus {
            color: #000;
            text-decoration: none;
            cursor: pointer;
        }

              /* The Modal pathway (background) */
        .modalpathway {
            display: none;
            /* Hidden by default */
            position: fixed;
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed sidebar-collapse">
    ...
    <div class="wrapper">
        @include('perawat.navbar')
        @include('perawat.sidebar')
        <div class="content-wrapper">
            @yield('container')
        </div>
        <footer class="main-footer">
            <strong><a href="https://adminlte.io">SIRAMAH-IGD</a>.</strong>
