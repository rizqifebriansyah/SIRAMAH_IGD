...
<div class="card-header bg-secondary">
    ...
    <button type="submit" class="btn btn-success cetakresumecpptdokterkebidanan"> <i class="fa fa-print"></i> Cetak assesmen dokter </button>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                @if($assesdokbid[0]->sumber_data == 'Pasien Sendiri')
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                @if($assesdokbid[0]->sumber_data == 'Keluarga')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                @if($assesdokbid[0]->macam_kasus == 'Non Trauma')
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                @if($assesdokbid[0]->macam_kasus == 'Trauma')
                        ...
                        <td>
                            <select class="form-control select2" name="trauma" id="trauma">
                                <option value=""> {{$assesdokbid[0]->trauma}}</option>
                                <option value="Keecelakaan Lalu Lintas">Keecelakaan Lalu Lintas
                                </option>
                                <option value="Kekerasan Dalam Rumah Tangga">Kekerasan Dalam Rumah Tangga
                                </option>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <textarea class="form-control" id="subyek" name="subyek" placeholder="">{{$assesdokbid[0]->keluhan_utama}}</textarea>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="TFU" aria-label="Recipient's username" id="tfu" name="tfu" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->tfu}}">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">Cm</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="TBJ ..." id="tbj" name="tbj" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->tbj}}">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">Gram</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="HIS" aria-label="Recipient's username" id="his" name="his" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->his}}">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">x/10 menit</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="DJJ ..." id="djj" name="djj" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->djj}}">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text" id="basic-addon2">dom</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-check col-sm-5 form-check-inline">
                                                                    @if($assesdokbid[0]->kontraksi == 'tidak')
                                                    ...
                                                    <tr>
                                                        <td class="text-bold font-italic" colspan="2">INSPEKSI <br>
                                                            <textarea class="form-control" id="inspeksi" name="inspeksi" placeholder="Ketik inspeksi ...">{{$assesdokbid[0]->inspeksi}}</textarea>
                                                        </td>

                                                        <td class="text-bold font-italic" colspan="2">INSPEKULO
                                                            <textarea class="form-control" id="inspekulo" name="inspekulo" placeholder="Ketik inspekulo ...">{{$assesdokbid[0]->inspekulo}}</textarea>
                                                            <br>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="text-bold font-italic" colspan="2">VT <br> <textarea class="form-control" id="vt" name="vt" placeholder="Ketik vt ...">{{$assesdokbid[0]->vt}}</textarea></td>

                                                        <td class="text-bold font-italic" colspan="2">RT <br> <textarea class="form-control" id="rt" name="rt" placeholder="Ketik rt ...">{{$assesdokbid[0]->rt}}</textarea></td>
                                                    </tr>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="promontorium" aria-label="Recipient's username" id="promontorium" name="promontorium" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->promontorium}}">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Linea ..." id="Linea" name="Linea" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Linea}}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Dinding" aria-label="Recipient's username" id="Dinding" name="Dinding" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Dinding}}">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Spina ..." id="Spina" name="Spina" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Spina}}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Distansia" aria-label="Recipient's username" id="Distansia" name="Distansia" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Distansia}}">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Interspinarum ..." id="Interspinarum" name="Interspinarum" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Interspinarum}}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="SAKRUM" aria-label="Recipient's username" id="SAKRUM" name="SAKRUM" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->SAKRUM}}">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Arkus Pubis ..." id="Arkus" name="Arkus" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Arkus}}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="Kesan Panggul" aria-label="Recipient's username" id="Kesan" name="Kesan" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->Kesan}}">
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" placeholder="imbang Pubis ..." id="imbang" name="imbang" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{$assesdokbid[0]->imbang}}">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <textarea class="form-control" id="diagnosis" name="diagnosis" placeholder="">{{$assesdokbid[0]->diagnosis}}</textarea>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <textarea class="form-control" id="planning" name="planning" placeholder="">{{$assesdokbid[0]->planning}}</textarea>
            ...
            <div class="accordion" id="accordionExample3">
                <div class="card">
                    ...
                    <div id="collapseOne3" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample3">
                        <div class="card-body bg-light">
                            <select class="form-control select2" name="alpul" id="alpul">
                                <option value="{{$assesdokbid[0]->cara_pulang}}">{{$assesdokbid[0]->cara_pulang}}</option>
                                <option value="Pasien Anak">Pasien Anak
                                </option>
                                <option value="Pasien Bedah">Pasien Bedah
                                </option>
            ...
            <div class="accordion" id="accordionExample4">
                <div class="card">
                    ...
                    <div id="collapseOne4" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample4">
                        <div class="card-body bg-light">
                            <select class="form-control select2" name="kopul" id="kopul">
                                <option value="{{$assesdokbid[0]->keadaan_pulang}}"> {{$assesdokbid[0]->keadaan_pulang}}</option>
...
<div id="printableArea">
 ...
 $(".cetakresumecpptdokterkebidanan").click(function() {
            kj = $('#kj').val()
            norm = $('#norm').val()
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        url: '<?= route('cetakresumecpptdokterkebidanan') ?>',
                        error: function(data) {
                            spinner.hide()
                            Swal.fire({
                                icon: 'error',
                        ...
                        success: function(data) {
                            ...
                            cetaktresumecpptkebidanan(data.kj, data.norm)
        ...
        function cetaktresumecpptkebidanan(kj, norm) {
            window.open('cetaktresumecpptkebidanan/' + kj + '/' + norm);
