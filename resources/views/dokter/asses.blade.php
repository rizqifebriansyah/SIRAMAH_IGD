...
@section('container')
    ...
    <div class="card-body ermdokterview">
        ...
        <div class="row center" style="align-content:center; margin-top: 10px">
            ...
            <div class="col-sm-2">
                <input type="date" class="form-control" id="tanggal_kunjungan" autocomplete="off" data-language="en"
                    data-date-format="yyyy-mm-dd" placeholder="Tanggal">
            </div>
