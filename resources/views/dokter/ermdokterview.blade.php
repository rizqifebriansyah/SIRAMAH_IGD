            ...
            <div class="col-md-2">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <a href="#" class="btn btn-success btn-block icare"><b>ICare BPJS</b></a><br>

                        <!-- {{-- <a class=" btn btn-primary btn-block " id="hasillabo">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card-header">
                                        ...
                                        <a class=" btn btn-info btn-sm  " id="hasilpa" href="#">
                                            <i class="bi bi-journal-text"></i>
                                            Hasil Lab PA
                                        </a>
                                    </div>
